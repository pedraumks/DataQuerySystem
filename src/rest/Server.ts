...
export default class Server {
    ...
    public start(): Promise<boolean> {
        ...
        try {
            ...
            that.rest.del('/dataset/:id', RouteHandler.delDataset);
            ...
            that.rest.post('/schedule', restify.bodyParser(), RouteHandler.makeSchedule);

            that.rest.post('/upload', restify.bodyParser(), RouteHandler.upload);
